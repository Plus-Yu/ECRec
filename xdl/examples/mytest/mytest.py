...
EMB_DIMENSION = 128
SPARSE_DIMENSION = 168641
NUM_COPIES = 2
CKPT = True
# TOTAL_NUM_STEPS = 226004
TOT_STEP = 8000 # for mlc exps
TOTAL_NUM_CKPTS = 8
CKPT_INTERVAL_NUM_STEPS = TOT_STEP/TOTAL_NUM_CKPTS
...
def train():
    ...
    emb1 = xdl.embedding('emb1', batch['sparse0'], xdl.UniformUnitScaling(factor=0.125), EMB_DIMENSION, SPARSE_DIMENSION, vtype='index')
